...
//==========================RED DE RUTAS==========================\\
    private void abmRedRutas() {
        ...
        double kms;
        while (!opcion.equals("0")) {
            //Mientras la oción sea distinta de 0
            ...
            switch (opcion) {
                ...
                case "2":
                    ...
                    try {
                        ...
                        auxSt = sc.nextLine();
                        idSol = Integer.parseInt(auxSt);
                        if (gestorPedidos.bajaPedido(codPostalSalida, codPostalLlegada, idSol)) {
                ...
                case "3":
                    ...
                    try {
                        ...
                        auxSt = sc.nextLine();
                        idSol = Integer.parseInt(auxSt);
                        solicitudAModificar = gestorPedidos.obtenerSolicitud(codPostalSalida, codPostalLlegada, idSol);
